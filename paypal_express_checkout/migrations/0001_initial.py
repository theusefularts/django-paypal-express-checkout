...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Item'
        db.create_table('paypal_express_checkout_item', (
        ...
        db.send_create_signal('paypal_express_checkout', ['Item'])
        ...
        db.send_create_signal('paypal_express_checkout', ['PaymentTransaction'])

        # Adding model 'PaymentTransactionError'
        db.create_table('paypal_express_checkout_paymenttransactionerror', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('response', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('paypal_express_checkout', ['PaymentTransactionError'])


    def backwards(self, orm):
        # Deleting model 'Item'
        db.delete_table('paypal_express_checkout_item')

        # Deleting model 'PaymentTransaction'
        db.delete_table('paypal_express_checkout_paymenttransaction')

        # Deleting model 'PaymentTransactionError'
        db.delete_table('paypal_express_checkout_paymenttransactionerror')
    ...
    models = {
        ...
        'paypal_express_checkout.paymenttransactionerror': {
            'Meta': {'object_name': 'PaymentTransactionError'},
    ...
    complete_apps = ['paypal_express_checkout']
